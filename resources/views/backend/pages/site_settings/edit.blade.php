            ...
            <div class="card-header bg-white border-bottom-0 pt-4 pb-0 px-4">
                <ul class="nav nav-tabs border-bottom-0" id="settingsTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active px-4 py-3 fw-semibold" id="general-tab" data-bs-toggle="tab" data-bs-target="#general" type="button" role="tab">General</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-4 py-3 fw-semibold" id="display-tab" data-bs-toggle="tab" data-bs-target="#display" type="button" role="tab">Display & Theme</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-4 py-3 fw-semibold" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab">Contact & Social</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-7">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body">
                                        <h5 class="mb-4">Brand Identity</h5>
                                        <div class="mb-3">
                            ...
                            <div class="col-lg-5">
                                <div class="card border-0 shadow-sm mb-4">
                                    <div class="card-body">
                                        <h5 class="mb-4">Media Assets</h5>
                                        {{-- Site Logo --}}
                                        <div class="mb-4">
                                            <label class="form-label d-flex justify-content-between align-items-center">
                                                <span>Site Logo</span>
                                                @if($settings->site_logo)
                                                    <span class="badge bg-success-subtle text-success border border-success-subtle">Custom</span>
                                                @else
                                            ...
                                            <input type="file" name="site_logo" id="siteLogoInput" class="form-control form-control-sm" accept="image/*">
                                            <div class="small text-muted mt-1 mb-2">Recommended: PNG/SVG (Max 2MB).</div>
                                            @if($settings->site_logo)
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <input type="file" name="site_favicon" id="siteFaviconInput" class="form-control form-control-sm" accept=".ico,.png,.jpg,.svg,.webp">
                                            <div class="small text-muted mt-1 mb-2">Recommended: 32x32px ICO/PNG.</div>
                                            @if($settings->site_favicon)
                                                <div class="form-check mt-1">
                                                    <input class="form-check-input" type="checkbox" name="remove_favicon" value="1" id="removeFaviconCheck">
                                                    <label class="form-check-label text-danger small" for="removeFaviconCheck">Reset to default</label>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="display" role="tabpanel">
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-body">
                                        <h5 class="mb-4">Public Display Controls</h5>
                                        <div class="mb-3">
                                            <label class="form-label">Gallery Layout Style</label>
                                            <select name="gallery_layout" class="form-select">
