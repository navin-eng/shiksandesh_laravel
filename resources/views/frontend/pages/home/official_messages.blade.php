@if($messages->count() > 0)
    <section class="section-block bg-light" style="padding: 80px 0; overflow: hidden;">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <p class="text-muted mt-3">Guiding our institution towards academic excellence and holistic development.</p>
            </div>
            
            <div class="row g-5 justify-content-center">
                @foreach($messages as $msg)
                    <div class="col-lg-5 col-md-6" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="official-card-modern h-100">
